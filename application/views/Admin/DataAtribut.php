            ...
            foreach ($atribut as $a) : ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="<?= base_url('DataAtribut/Hapus/' . $a['id_atribut']) ?>" class="btn btn-danger btn-action" data-toggle="tooltip" title="Delete" onclick="Yakin?"><i class="fas fa-trash"></i> Hapus</a>
                </td>
              </tr>
            <?php endforeach ?>
          </tbody>
...
<div class="modal fade" id="TAtribut">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url('DataAtribut') ?>" method="POST">
  ...
  <div class="modal fade" id="EditAtribut<?= $a['id_atribut'] ?>">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?= base_url('DataAtribut/Edit') ?>" method="POST">
          <div class="modal-body">
            <div class="form-group">
